...
module Backup
  module Database
    ...
    #       database Backup::Database::ElasticsearchV2 do |db|
    #         db.indices = 'test'
    #       end
    #
    ...
    class ElasticsearchV2 < Base
      ...
      def client
        @client ||= ::ElasticsearchV2::Client.new url: url, logger: logger
      end
...
::Backup::Config::DSL::Elasticsearch = ::Backup::Database::ElasticsearchV2
