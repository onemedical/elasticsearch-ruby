module ElasticsearchV2
  module Transport
    ...
    class Client
      ...
      #
      # @see ElasticsearchV2::Transport::Transport::Base
      # @see ElasticsearchV2::Transport::Transport::HTTP::Faraday
      #
      attr_accessor :transport

      # Create a client connected to an Elasticsearch cluster.
      #
      # Specify the URL via arguments or set the `ELASTICSEARCH_V2_URL` environment variable.
      #
      ...
      #                                        {ElasticsearchV2::Transport::Transport::Connections::Selector::Base}.
      #
      ...
      def initialize(arguments={}, &block)
        ...
        hosts = @arguments[:hosts] || \
                ...
                @arguments[:url]   || \
                @arguments[:urls]  || \
                ENV.fetch('ELASTICSEARCH_V2_URL', 'localhost:9200')
      ...
      #
      # TODO: Refactor, so it's available in ElasticsearchV2::Transport::Base as well
      #
      # @return [Array<Hash>]
      # @raise  [ArgumentError]
      #
