...
# Launch test cluster
#
if ENV['SERVER'] and not ElasticsearchV2::Extensions::Test::Cluster.running?
  ...
  ElasticsearchV2::Extensions::Test::Cluster.start(nodes: 1, es_params: es_params )
end

# Register `at_exit` handler for server shutdown.
# MUST be called before requiring `test/unit`.
#
at_exit { ElasticsearchV2::Extensions::Test::Cluster.stop if ENV['SERVER'] and ElasticsearchV2::Extensions::Test::Cluster.running? }
...
$client ||= ElasticsearchV2::Client.new url: url
...
include ElasticsearchV2::YamlTestSuite
...
suites.each do |suite|
  name = ElasticsearchV2::YamlTestSuite::Utils.titleize(suite.basename)

  ElasticsearchV2::YamlTestSuite::Runner.in_context name do
