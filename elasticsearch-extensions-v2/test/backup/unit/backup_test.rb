...
class ElasticsearchV2::Extensions::BackupTest < Test::Unit::TestCase
  context "The Backup gem extension" do
    setup do
      @model = stub trigger: true
      @subject = ::Backup::Database::ElasticsearchV2.new(@model)
    end

    should "have a client" do
      assert_instance_of ElasticsearchV2::Transport::Client, @subject.client
    end
    ...
    should "be configurable" do
      @subject = ::Backup::Database::ElasticsearchV2.new(@model) do |db|
    ...
    should "raise an expection for an unsupported type of backup" do
      @subject = ::Backup::Database::ElasticsearchV2.new(@model) { |db| db.mode = 'foobar' }
      assert_raise ::Backup::Database::ElasticsearchV2::Error do
        @subject.perform!
      end
    end

    should "scan and scroll the index" do
      @subject = ::Backup::Database::ElasticsearchV2.new(@model) { |db| db.indices = 'test' }
