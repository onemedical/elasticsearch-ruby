...
module ElasticsearchV2
  module Test
    class SearchFilterTest < ::Test::Unit::TestCase
      subject { ElasticsearchV2::DSL::Search::Filter.new }
      ...
      context "Search Filter" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = ElasticsearchV2::DSL::Search::Filter.new &block

          subject.expects(:instance_eval)
          assert_instance_of ElasticsearchV2::DSL::Search::Filter, subject.call
        end
