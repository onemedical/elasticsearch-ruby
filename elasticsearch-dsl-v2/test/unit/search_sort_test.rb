    ...
    class SearchSortTest < ::Test::Unit::TestCase
      ...
      context "Search sort" do
        ...
        should "not be empty" do
          subject = ElasticsearchV2::DSL::Search::Sort.new foo: { order: 'desc' }
