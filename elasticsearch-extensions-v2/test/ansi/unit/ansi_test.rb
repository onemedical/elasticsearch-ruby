...
class ElasticsearchV2::Extensions::AnsiTest < Test::Unit::TestCase
  context "The ANSI extension" do
    setup do
      @client = ElasticsearchV2::Client.new
      @client.stubs(:perform_request).returns \
        ElasticsearchV2::Transport::Transport::Response.new(200, { "ok" => true, "status" => 200, "name" => "Hit-Maker",
    ...
    should "wrap the response" do
      ...
      assert_instance_of ElasticsearchV2::Extensions::ANSI::ResponseBody, response
    ...
    should "call the 'awesome_inspect' method when available and no handler found" do
      @client.stubs(:perform_request).returns \
        ElasticsearchV2::Transport::Transport::Response.new(200, {"index-1"=>{"aliases"=>{}}})
