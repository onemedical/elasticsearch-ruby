  ...
  module Transport
    module Transport
      module HTTP
        ...
        # @example HTTP
        #
        #     require 'elasticsearch_v2/transport/transport/http/manticore'
        #
        #     client = ElasticsearchV2::Client.new transport_class: ElasticsearchV2::Transport::Transport::HTTP::Manticore
        #
        ...
        #       transport_class: ElasticsearchV2::Transport::Transport::HTTP::Manticore,
        #       ssl: {
