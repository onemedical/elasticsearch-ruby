...
module ElasticsearchV2
  module Extensions
    module Test
      ...
      #
      #      require 'elasticsearch_v2/extensions/test/cluster'
      #      ElasticsearchV2::Extensions::Test::Cluster.start command: 'elasticsearch-5.1.1/bin/elasticsearch'
      #
      ...
      module Cluster
        ...
        class Cluster
          ...
          #      ElasticsearchV2::Extensions::Test::Cluster::Cluster.new.start
          #
          # @example Start a cluster with a custom configuration
          #      ElasticsearchV2::Extensions::Test::Cluster::Cluster.new(
          ...
          #      ElasticsearchV2::Extensions::Test::Cluster::Cluster.new.stop
          #
          # @example Stop the cluster reachable on specific port
          #      ElasticsearchV2::Extensions::Test::Cluster::Cluster.new(port: 9350).stop
          #
          # @return Boolean,Array
          # @see Cluster#start
          #
