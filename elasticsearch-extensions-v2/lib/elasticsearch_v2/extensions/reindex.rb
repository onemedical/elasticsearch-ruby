...
module ElasticsearchV2
  module Extensions
    ...
    module Reindex
      ...
      ElasticsearchV2::API::Actions.__send__ :include, API if defined?(ElasticsearchV2::API::Actions)
      ElasticsearchV2::Transport::Client.__send__ :include, API if defined?(ElasticsearchV2::Transport::Client) && defined?(ElasticsearchV2::API)
      ...
      #
      #     source_client  = ElasticsearchV2::Client.new url: 'http://localhost:9200'
      #     target_client  = ElasticsearchV2::Client.new url: 'http://localhost:9250'
      #
      #     reindex = ElasticsearchV2::Extensions::Reindex.new \
