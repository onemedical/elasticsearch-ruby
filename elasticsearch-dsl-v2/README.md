...
client = ElasticsearchV2::Client.new trace: true
...
client = ElasticsearchV2::Client.new transport_options: { request: { timeout: 3600, open_timeout: 3600 } }
