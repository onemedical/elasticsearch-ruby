...
module ElasticsearchV2
  module Test
    class SearchAggregationTest < ::Test::Unit::TestCase
      subject { ElasticsearchV2::DSL::Search::Aggregation.new }
      ...
      context "Search Aggregation" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = ElasticsearchV2::DSL::Search::Aggregation.new &block

          subject.expects(:instance_eval)
          assert_instance_of ElasticsearchV2::DSL::Search::Aggregation, subject.call
        end
