...
module ElasticsearchV2
  module Test
    class SearchQueryTest < ::Test::Unit::TestCase
      subject { ElasticsearchV2::DSL::Search::Query.new }
      ...
      context "Search Query" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = ElasticsearchV2::DSL::Search::Query.new &block

          subject.expects(:instance_eval)
          assert_instance_of ElasticsearchV2::DSL::Search::Query, subject.call
        end
